...
module.exports =  class HumanPlayer extends Player {
  ...
  getMove(board){
    ...
    const directionVec = this.getRandomDirectionVec(board, piecePositions[targetIndex])
    return {currentPos:  piecePositions[targetIndex], nextPos: piecePositions[targetIndex].plus(directionVec)}
  }
